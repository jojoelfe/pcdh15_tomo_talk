var mySVG;
export function findIntersect(probe,path,polygon1,polygon2,svg)
{
        mySVG = svg;
        //============elem1======================
             circle2Polygon(probe,polygon1)


               
              var shape1=probe.nodeName

             path2Polygon(path,polygon2)

            if(true)
            {
                 //---is path closed ---
                var pntStng=path.getAttribute("d")
                ...
                var pathStng=path.getAttribute("d").toLowerCase()
                 if(  //---smooth path--
            ...
            return(intersections.length);//---show intersect points---
